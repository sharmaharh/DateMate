...
- (void)refreshHorizontalScrollIndicatorWithAlpha:(CGFloat)alpha
{
    ...
    CGFloat movementCoefficient = (self.contentOffset.x/self.contentSize.width);
    CGFloat indicatorXmovement = (self.frame.size.width-JMOScrollIndicatorWidth)*movementCoefficient;
